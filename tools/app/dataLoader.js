import { loadSmithData } from '../../smith/app/dataLoader.js?v=4645d7a6d8';

const BONUSES_DATA_URL = new URL('../../bonuses/bonuses.json?v=b31bc7a73b', import.meta.url);
...
const SMITH_MODULE_URL = new URL('../../smith/module.js?v=499f304969', import.meta.url).toString();

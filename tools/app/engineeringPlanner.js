import { computeEngineeringSteadyStateThroughput, computeEngineeringThroughput } from '../../bonuses/lib/engineeringThroughput.js?v=d8856f548a';
    ...
    engineeringProductionMaxPercent(bonusId) {
        ...
        return this.data.sources
            ...
            .reduce((total, src) => total + src.bonuses
                ...
                .reduce((sum, b) => sum + this.resolveValue(b), 0), 0);
    },

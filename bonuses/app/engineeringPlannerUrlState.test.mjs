...

{
    ...
    assert.equal(app.engineeringPlannerState.mode, 'throughput_game', 'URL state restores in-game throughput mode');
...

{
    ...
    assert.equal(app.engineeringPlannerState.mode, 'throughput_calc', 'URL state restores calculator throughput mode');
}

...
const BONUSES_DATA_URL = new URL('../bonuses.json?v=a546223444', import.meta.url);
const ATLAS_MANIFEST_URL = new URL('../../generated/image-atlas-manifest.json?v=eb95fc2350', import.meta.url);

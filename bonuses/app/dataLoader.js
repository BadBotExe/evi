...
const BONUSES_DATA_URL = new URL('../bonuses.json?v=4530c09296', import.meta.url);
const ATLAS_MANIFEST_URL = new URL('../../generated/image-atlas-manifest.json?v=609efe04ce', import.meta.url);

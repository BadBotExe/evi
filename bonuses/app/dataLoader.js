...
const BONUSES_DATA_URL = new URL('../bonuses.json?v=586e1af080', import.meta.url);
const ATLAS_MANIFEST_URL = new URL('../../generated/image-atlas-manifest.json?v=8183c4fb6b', import.meta.url);
